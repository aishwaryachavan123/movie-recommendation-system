...
import movieSystemmoviesystem.DataCollection.MovieRating;                              
...
//
	    ...
	    private static Map<Integer, Map<Integer, Double>> calculateUserSimilarity(Map<Integer, Map<Integer, Double>> userItemMatrix) {
	    ...
	    private static Map<Integer, Map<Integer, Double>> calculateItemSimilarity(Map<Integer, Map<Integer, Double>> userItemMatrix) {
	    ...
	    private static double calculateCosineSimilarity(Map<Integer, Map<Integer, Double>> userItemMatrix, int movieId1, int movieId2) {
	    ...
	    private static List<Integer> getTopRecommendedMovies(int targetUserId, Map<Integer, Map<Integer, Double>> userSimilarityMatrix,
